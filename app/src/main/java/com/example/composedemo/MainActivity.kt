...
import com.example.composedemo.activity.InAppPurchaseAC
import com.example.composedemo.activity.IntrinsicSizeAC
...
import com.example.composedemo.activity.ThemeAC
import com.example.composedemo.activity.ViewModelAC
...
fun LazyListDemo() {
    ...
    listItems.add(ActivityItem(GestureAC::class.simpleName.toString(), GestureAC::class.java))
    listItems.add(ActivityItem(NavigationAC::class.simpleName.toString(), NavigationAC::class.java))
    ...
    listItems.add(ActivityItem(ViewModelAC::class.simpleName.toString(), ViewModelAC::class.java))
